          ...
          <div key={lineNumber} data-line-number={lineNumber} data-line-side="new">
            <div className={`flex transition-colors ${highlighted ? "bg-blue-900/20" : "hover:bg-ctp-base"}`}>
              ...
              >
                {gutterHovered && (
                  <span
                    className="absolute left-0.5 top-1/2 -translate-y-1/2 z-10 flex items-center justify-center w-5 h-5 rounded-full bg-ctp-blue hover:bg-ctp-sapphire cursor-pointer text-ctp-base opacity-80 hover:opacity-100 transition-all"
                    title="Add comment"
                  >
